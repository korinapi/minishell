...
/*   Updated: 2024/04/03 19:45:48 by mleibeng         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_error2(char *program_name, char *operation, char *arg, char *error_message)
{
	ft_fprintf(STDOUT_FILENO, "%s: %s: %s: %s\n", program_name, operation, arg, error_message);
}